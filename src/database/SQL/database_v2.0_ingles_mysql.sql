...
CREATE TABLE `promacol_v3`.`product_job`(
    ...
    -- DOCUMENTO_IDENTIDAD
INSERT INTO `promacol_v3`.`identity_document`(descrip) VALUES ('VENEZOLANO');

    -- ROL
INSERT INTO `promacol_v3`.`role`(role_id, role_name) VALUES (1, 'Administrador');
INSERT INTO `promacol_v3`.`role`(role_id, role_name) VALUES (2, 'Analista');
INSERT INTO `promacol_v3`.`role`(role_id, role_name) VALUES (3, 'Cajero');
INSERT INTO `promacol_v3`.`role`(role_id, role_name) VALUES (4, 'Supervisor de sistema');
INSERT INTO `promacol_v3`.`role`(role_id, role_name) VALUES (5, 'Supervisor de peso');
INSERT INTO `promacol_v3`.`role`(role_id, role_name) VALUES (6, 'Jefe');
INSERT INTO `promacol_v3`.`role`(role_id, role_name) VALUES (7, 'Gerente');
INSERT INTO `promacol_v3`.`role`(role_id, role_name) VALUES (8, 'Obrero');
INSERT INTO `promacol_v3`.`role`(role_id, role_name) VALUES (9, 'Sanetizacion');
INSERT INTO `promacol_v3`.`role`(role_id, role_name) VALUES (10, 'Coordinador de producción');
...
INSERT INTO `promacol_v3`.`category`(category_id, category_name)VALUES (2, 'Obrero');
...
INSERT INTO `promacol_v3`.`job`(job_id, category_id, job_name)VALUES (4, 2, 'Revisador de carne negra');
INSERT INTO `promacol_v3`.`job`(job_id, category_id, job_name)VALUES (5, 2, 'Revisador de carne jumbo');
INSERT INTO `promacol_v3`.`job`(job_id, category_id, job_name)VALUES (6, 2, 'Desconchador');

INSERT INTO `promacol_v3`.`job`(job_id, category_id, job_name)VALUES (7, 1, 'Administrador');
INSERT INTO `promacol_v3`.`job`(job_id, category_id, job_name)VALUES (8, 1, 'Analista');
INSERT INTO `promacol_v3`.`job`(job_id, category_id, job_name)VALUES (9, 1, 'Cajero');
INSERT INTO `promacol_v3`.`job`(job_id, category_id, job_name)VALUES (10, 1, 'Supervisor de sistema');
INSERT INTO `promacol_v3`.`job`(job_id, category_id, job_name)VALUES (11, 1, 'Supervisor de peso');
INSERT INTO `promacol_v3`.`job`(job_id, category_id, job_name)VALUES (12, 1, 'Jefe');
...
INSERT INTO `promacol_v3`.`measure_type`(descrip)VALUES ('Volumen');

    -- MEDIDA
INSERT INTO `promacol_v3`.`measure`(measure_type_id, name, symbol)VALUES (1, 'gramo', 'g');
INSERT INTO `promacol_v3`.`measure`(measure_type_id, name, symbol)VALUES (1, 'kilogramo', 'Kg');

    -- PRODUCTO
INSERT INTO `promacol_v3`.`product` (prod_id, measure_id, prod_name, descrip) VALUES (1, 1,'Jumbo', null);
INSERT INTO `promacol_v3`.`product` (prod_id, measure_id, prod_name, descrip) VALUES (2, 1,'Lump', null);
INSERT INTO `promacol_v3`.`product` (prod_id, measure_id, prod_name, descrip) VALUES (3, 1,'Claw', null);
INSERT INTO `promacol_v3`.`product` (prod_id, measure_id, prod_name, descrip) VALUES (4, 1,'Cocktail', null);
INSERT INTO `promacol_v3`.`product` (prod_id, measure_id, prod_name, descrip) VALUES (5, 1,'R/Lump', null);
INSERT INTO `promacol_v3`.`product` (prod_id, measure_id, prod_name, descrip) VALUES (6, 1,'R/Claw', null);
INSERT INTO `promacol_v3`.`product` (prod_id, measure_id, prod_name, descrip) VALUES (7, 1,'R/Cocktail', null);
INSERT INTO `promacol_v3`.`product` (prod_id, measure_id, prod_name, descrip) VALUES (8, 1,'R/Jumbo', null);
INSERT INTO `promacol_v3`.`product` (prod_id, measure_id, prod_name, descrip) VALUES (9, 1,'Cesta/Desc', null);

    -- ZONA EXTRACCION
INSERT INTO `promacol_v3`.`catch_zone` (catch_zone_name, catch_zone_code ) VALUES ('La Rita', '01');
INSERT INTO `promacol_v3`.`catch_zone` (catch_zone_name, catch_zone_code ) VALUES ('Pta Gorda', '02');
INSERT INTO `promacol_v3`.`catch_zone` (catch_zone_name, catch_zone_code ) VALUES ('Positos', '03');
INSERT INTO `promacol_v3`.`catch_zone` (catch_zone_name, catch_zone_code ) VALUES ('Bachaquero', '04');
INSERT INTO `promacol_v3`.`catch_zone` (catch_zone_name, catch_zone_code ) VALUES ('Mene Grande', '05');
INSERT INTO `promacol_v3`.`catch_zone` (catch_zone_name, catch_zone_code ) VALUES ('Moteo', '06');
INSERT INTO `promacol_v3`.`catch_zone` (catch_zone_name, catch_zone_code ) VALUES ('Bobure', '07');
INSERT INTO `promacol_v3`.`catch_zone` (catch_zone_name, catch_zone_code ) VALUES ('San Francisco', '08');
INSERT INTO `promacol_v3`.`catch_zone` (catch_zone_name, catch_zone_code ) VALUES ('La Cañada', '09');
INSERT INTO `promacol_v3`.`catch_zone` (catch_zone_name, catch_zone_code ) VALUES ('Caño O', '10');
INSERT INTO `promacol_v3`.`catch_zone` (catch_zone_name, catch_zone_code ) VALUES ('Barranquita', '11');
...
INSERT INTO `promacol_v3`.`currency`(name, abbrev) VALUES('Bolivar', 'Bs');
INSERT INTO `promacol_v3`.`currency`(name, abbrev) VALUES('Dolar', '$');

    -- USUARIO
INSERT INTO `promacol_v3`.`user`(employee_id, username, password, status) VALUES(1,'luisb', '$2a$10$E79wfw.vWdoT72KF.43OAOexE7qXZu7R.OFCtN3mfXLDlIiAieD4W', true);
INSERT INTO `promacol_v3`.`user`(employee_id, username, password, status) VALUES(2,'albertob', '$2a$10$E79wfw.vWdoT72KF.43OAOexE7qXZu7R.OFCtN3mfXLDlIiAieD4W', true);
INSERT INTO `promacol_v3`.`user`(employee_id, username, password, status) VALUES(3,'eddyb', '$2a$10$E79wfw.vWdoT72KF.43OAOexE7qXZu7R.OFCtN3mfXLDlIiAieD4W', true);

    -- ROL_USUARIO
INSERT INTO `promacol_v3`.`user_role`(role_id, user_id)VALUES (1, 1);
INSERT INTO `promacol_v3`.`user_role`(role_id, user_id)VALUES (2, 2);
INSERT INTO `promacol_v3`.`user_role`(role_id, user_id)VALUES (3, 3);


    -- PRODUCTO_JOB
INSERT INTO `promacol_v3`.`product_job`(job_id, prod_id) VALUES(1, 1);
INSERT INTO `promacol_v3`.`product_job`(job_id, prod_id) VALUES(1, 2);
INSERT INTO `promacol_v3`.`product_job`(job_id, prod_id) VALUES(2, 3);
INSERT INTO `promacol_v3`.`product_job`(job_id, prod_id) VALUES(2, 4);
INSERT INTO `promacol_v3`.`product_job`(job_id, prod_id) VALUES(3, 5);
INSERT INTO `promacol_v3`.`product_job`(job_id, prod_id) VALUES(4, 6);
INSERT INTO `promacol_v3`.`product_job`(job_id, prod_id) VALUES(4, 7);
INSERT INTO `promacol_v3`.`product_job`(job_id, prod_id) VALUES(5, 8);
INSERT INTO `promacol_v3`.`product_job`(job_id, prod_id) VALUES(6, 9);
...
INSERT INTO  `promacol_v3`.`price`(price_id, currency_id, price) VALUE (4, 2, 0); 
INSERT INTO  `promacol_v3`.`price`(price_id, currency_id, price) VALUE (5, 1, 0); 
INSERT INTO  `promacol_v3`.`price`(price_id, currency_id, price) VALUE (6, 2, 0); 
INSERT INTO  `promacol_v3`.`price`(price_id, currency_id, price) VALUE (7, 1, 0); 
INSERT INTO  `promacol_v3`.`price`(price_id, currency_id, price) VALUE (8, 2, 0); 
INSERT INTO  `promacol_v3`.`price`(price_id, currency_id, price) VALUE (9, 1, 0); 
INSERT INTO  `promacol_v3`.`price`(price_id, currency_id, price) VALUE (10, 2, 0); 
INSERT INTO  `promacol_v3`.`price`(price_id, currency_id, price) VALUE (11, 1, 0); 
INSERT INTO  `promacol_v3`.`price`(price_id, currency_id, price) VALUE (12, 2, 0); 
INSERT INTO  `promacol_v3`.`price`(price_id, currency_id, price) VALUE (13, 1, 0); 
INSERT INTO  `promacol_v3`.`price`(price_id, currency_id, price) VALUE (14, 2, 0);
INSERT INTO  `promacol_v3`.`price`(price_id, currency_id, price) VALUE (15, 1, 0); 
INSERT INTO  `promacol_v3`.`price`(price_id, currency_id, price) VALUE (16, 2, 0);
...
INSERT INTO  `promacol_v3`.`product_price`(prod_id, price_id) VALUE (2, 3);
INSERT INTO  `promacol_v3`.`product_price`(prod_id, price_id) VALUE (2, 4);
INSERT INTO  `promacol_v3`.`product_price`(prod_id, price_id) VALUE (3, 5);
INSERT INTO  `promacol_v3`.`product_price`(prod_id, price_id) VALUE (3, 6);
INSERT INTO  `promacol_v3`.`product_price`(prod_id, price_id) VALUE (4, 7);
INSERT INTO  `promacol_v3`.`product_price`(prod_id, price_id) VALUE (4, 8);
INSERT INTO  `promacol_v3`.`product_price`(prod_id, price_id) VALUE (5, 9);
INSERT INTO  `promacol_v3`.`product_price`(prod_id, price_id) VALUE (5, 10);
INSERT INTO  `promacol_v3`.`product_price`(prod_id, price_id) VALUE (6, 11);
INSERT INTO  `promacol_v3`.`product_price`(prod_id, price_id) VALUE (6, 12);
INSERT INTO  `promacol_v3`.`product_price`(prod_id, price_id) VALUE (7, 13);
INSERT INTO  `promacol_v3`.`product_price`(prod_id, price_id) VALUE (7, 14);
INSERT INTO  `promacol_v3`.`product_price`(prod_id, price_id) VALUE (8, 15);
INSERT INTO  `promacol_v3`.`product_price`(prod_id, price_id) VALUE (8, 16);
INSERT INTO  `promacol_v3`.`product_price`(prod_id, price_id) VALUE (9, 17);
INSERT INTO  `promacol_v3`.`product_price`(prod_id, price_id) VALUE (9, 18);
